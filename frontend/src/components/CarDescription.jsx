    ...
    <div className="flex gap-2">
        <div className="border border-gray-100 shadow-md rounded-lg p-6 m-4 w-3/4">
            <div className="flex flex-col gap-4">
                <span className="text-base pb-3 text-black font-bold">Opis pojazdu </span>
                ...
                <span className="text-base pb-4 text-black font-bold">Dodatkowe informacje</span>
        ...
        <div className="border border-gray-100 shadow-md rounded-lg p-6 m-4 h-full w-1/4">
            <div className="flex flex-col gap-4">
                <span className="text-base pb-2 text-black font-bold">Raport pojazdu</span> 
                ...
                <span className="text-base text-black font-bold">Historia serwisowa</span>
